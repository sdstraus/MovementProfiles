...
bf_dispersal <- bf(dispersal_km ~ log(Mass_kg) + (log(Mass_kg)|class)) + Gamma(link = "log")
bf_home_range <- bf(mean.hra.m2 ~ log(Mass_kg) + (log(Mass_kg)|class)) + Gamma(link = "log")
bf_migration <- bf(Migration_km ~ log(Mass_kg) + (log(Mass_kg)|class)) + hurdle_gamma(link = 'log')
