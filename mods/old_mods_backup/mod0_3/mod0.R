...
setwd("/Users/sam/SUPS_meta/data/")
...
which(is.na(traits_phylo$class) == T) #42
...
mod0_prior <- get_prior(bf_dispersal + bf_home_range + bf_migration + set_rescor(FALSE), cov_ranef = list(scientific_name.x = A),
                        data = traits_phylo,save_model = "mod0_s", save_dso = TRUE,  
  file = "mod0_logn_saved")
