...
bf_dispersal <- bf(dispersal_km ~ log(Mass_kg) + (1|class) + (1|scientific_name.x)) + lognormal(link = "identity")
bf_home_range <- bf(mean.hra.m2 ~ log(Mass_kg) + (1|class) + (1|scientific_name.x)) + lognormal(link = "identity")
bf_migration <- bf(Migration_km ~ log(Mass_kg) + (log(Mass_kg)|class) + (1|scientific_name.x)) + hurdle_lognormal(link = 'identity')
