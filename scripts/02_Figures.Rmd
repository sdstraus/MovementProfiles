...
## class
class_nondispersal_migrators <- readRDS("../mods/class.disp_withyear_nonmigrators.rds")
class_nonforaging_migrators <- readRDS("../mods/class.for_withyear_nonmigrators.rds")
...
while (!is.null(dev.list()))  dev.off()
jpeg(filename = "FigS3_nonmigrators_03May2023.jpeg", width = 10, height = 10, units = 'in', res = 1000)
