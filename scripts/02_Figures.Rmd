...
diet_cols <- c(Carnivore = "#45681E", Herbivore = "#A3981C", 
                Invertivore = "#CDCA82", Omnivore = "#85B6CE")
...
media_cols <- c(air = "#41476b", land = "#9e6374", freshwater = "#c67b6f", marine = "#de9b71")


# hist by media
traits$media_foraging[which(traits$media_foraging =="water")] <- "freshwater"
traits$media_foraging[which(traits$media_foraging =="aquatic")] <- "freshwater"

media_for_distr <- traits %>%
  filter(media_foraging == "air" | media_foraging == "land" |
           media_foraging == "freshwater"| media_foraging == "marine") %>%
...
traits$media_dispersal[which(traits$media_dispersal =="water")] <- "freshwater"
traits$media_foraging[which(traits$media_foraging =="aquatic")] <- "freshwater"

media_disp_distr <- traits %>%
  filter(media_dispersal == "air" | media_dispersal == "land" |
           media_dispersal == "freshwater"| media_dispersal == "marine") %>%
...
traits$media_migration[which(traits$media_migration =="water")] <- "freshwater"
traits$media_foraging[which(traits$media_foraging =="aquatic")] <- "freshwater"

media_mig_distr <- traits %>%
  filter(media_migration == "air" | media_migration == "land" |
           media_migration == "freshwater"| media_migration == "marine") %>%
...
jpeg(filename = "../figures/distr_by_hypothesis_May2023.jpeg", width = 12, height = 11, units = 'in', res = 1000)
...
while (!is.null(dev.list()))  dev.off()
jpeg(filename = "Fig5_epreds_01May2023.jpeg", width = 10, height = 10, units = 'in', res = 1000)
...
while (!is.null(dev.list()))  dev.off()
jpeg(filename = "Fig2a_migrators_03May2023.jpeg", width = 10, height = 10, units = 'in', res = 1000)
grid.arrange(gA, gD, gB, gE,gC, gF, nrow = 3, padding = 2)
dev.off()
```
...
while (!is.null(dev.list()))  dev.off()
jpeg(filename = "FigS3_nonmigrators_03May2023.jpeg", width = 10, height = 7, units = 'in', res = 1000)
grid.arrange(gA, gB, gC, gD, nrow = 2, padding = 2)
dev.off()
```
