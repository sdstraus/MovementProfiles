...
jpeg(filename = "../figures/distr_by_hypothesis_May2023.jpeg", width = 8.75, height = 10, units = 'in', res = 1000)
...
while (!is.null(dev.list()))  dev.off()
jpeg(filename = "../figures/Fig5_epreds_01May2023.jpeg", width = 10, height = 10, units = 'in', res = 1000)
grid.arrange(gA, gD, gB, gE,gC, gF, nrow = 3, padding = 2)
dev.off()
