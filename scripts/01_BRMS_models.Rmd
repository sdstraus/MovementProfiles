...
class.disp_withyear_migrators <- brm(bf_dispersal_class_withyear_migrators, data = traits_migrators, 
                         control = list(adapt_delta = 0.995, max_treedepth=20), 
                         iter = 4000, cores = 4, prior = class_withyear_prior_migrators)
...
saveRDS(class.disp_withyear_migrators, "../mods/class.disp_withyear_migratorss.rds")
...
## works
trophic.disp_withyea_migratorsr <- brm(bf_dispersal_trophic_withyear_migrators, data = traits_migrators, 
                          control = list(adapt_delta = 0.995, max_treedepth=20), 
                          iter = 3000, cores = 16,
...
saveRDS(trophic_year_prior_mig_migrators, "../mods/trophic_year_prior_mig_migrators.rds")
```


Moving on to non-migrators, univariate model, grouped by class
```{r migrators only, class univar mod with year}
traits_nonmigrators <- traits_phylo %>% filter(Migration_km == 0)



>>>>>>> 030b89713bf99e5ce9a884bad7e33fd2dcf99496
