...
Looking at breakdown of migrators and non-migrators, starting with non-migrators
```{r non-migrators only, univar with year}
nonmig <- traits_phylo %>% filter(Migration_km > 0)
