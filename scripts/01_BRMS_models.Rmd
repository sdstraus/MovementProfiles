...
order_withyear_prior_mam <- prior(normal(0,6),class = 'b', coef = logMass_kg) +
  prior(student_t(3, 0, 6), class = 'Intercept') +
  prior(student_t(3, 0, 5), class = 'sd') +
  prior(student_t(3, 0, 5), class = 'sigma')

mam.mig_withyear <- brm(bf_migration_mam_withyear, data = mam, 
                        control = list(adapt_delta = 0.995, max_treedepth=20), 
                        iter = 3000, cores = 4, prior = order_withyear_prior_mam)
